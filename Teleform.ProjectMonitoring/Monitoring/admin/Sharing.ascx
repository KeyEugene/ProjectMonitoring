...
<%@ Register TagPrefix="Navigation" TagName="Frame" Src="~/NavigationFrame/admin/NavigationFrame_6.ascx" %>
...
<asp:MultiView ActiveViewIndex="0" runat="server" ID="MView">
    <asp:View runat="server" ID="GridV">
        ...
        <br />--%>
        <asp:GridView runat="server" CssClass="GVPermission table table-bordered table-hover" ID="GVPermission" AutoGenerateColumns="false"
    ...
    <asp:View runat="server" ID="TemplateTableView">
        ...
        <br />
        <asp:GridView runat="server" ID="GVTemplate" CssClass="GVTemplate table table-bordered table-hover" AutoGenerateColumns="false"
