...
{
    public class CrossTemplateExcelBuilder : BaseExcelBuilder
    {
        ...
        public override void addDataRows(SheetData sheetData, GroupReport report)
        {
            ...
            foreach (Instance instance in report.Instances)
            {
                ...
                foreach (Instance.Property property in instance.OwnProperties) // TemplateField field in report.Template.Fields)
                {
